...
import { windowHeight as deviceHeight, windowWidth as deviceWidth } from './const.styles';
...
export const normalize = (func: keyof typeof normalizeFunctions, px: number): number =>
